...
class NodeSchema(BaseModel):
    ...
    rabbit_holes: list[str] = Field(default_factory=list, description="3 downstream exploration vectors")
    suggested_questions: list[str] = Field(default_factory=list, description="3-4 provocative curiosity questions generated by LLM")
...
class ResearchDossierSchema(BaseModel):
    ...
    suggestedQuestions: list[str] = Field(default_factory=list, description="3-4 provocative curiosity questions")
    audioTourScript: str = ""
